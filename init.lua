...
-- Arrow keys in normal mode move cursor by 10/50 lines
vim.keymap.set('n', '<left>', '50k')
vim.keymap.set('n', '<right>', '50j')
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', function()
        ...
        table.insert(args, '--glob=!yarn.lock')
